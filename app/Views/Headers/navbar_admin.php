...
<div class='dashboard'>
    <div class="dashboard-nav">
        <header>
            ...
            <a href="#" class="brand-logo"><i class="fas fa-anchor"></i> <span>GUIDE MAKER</span></a>
        </header>
        <nav class="dashboard-nav-list">
            <a href="<?= PATH . '/admin'; ?>" class="dashboard-nav-item">
                <i class="fas fa-home"></i>
                Home </a>
            <a href="<?= PATH . '/admin/guide'; ?>" class="dashboard-nav-item active"><i class="fas fa-tachometer-alt"></i> guides
            </a>
            <?php if ($prj > 0) { ?>
                <a href="<?= PATH . '/admin/section'; ?>" class="dashboard-nav-item"><i class="fas fa-file-upload"></i> <?= lang('guide.section'); ?> </a>
                <div class='dashboard-nav-dropdown'><a href="#!" class="dashboard-nav-item dashboard-nav-dropdown-toggle">
                    ...
                    <div class='dashboard-nav-dropdown-menu'>
                        <a href="<?= PATH . '/admin/media/all'; ?>" class="dashboard-nav-dropdown-item">All</a>
                        <a href="<?= PATH . '/admin/media/last'; ?>" class="dashboard-nav-dropdown-item">Recent</a>
